...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    ...
    loginRequestModel.password = "pistol";
  }
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            SizedBox(height: 60,),
            Text("KARMA",style: TextStyle(fontSize: 55,fontWeight: FontWeight.bold,color: Colors.white54),),
            Text("Uniting Power",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500,color: Colors.white),),
            Stack(
              children: <Widget>[
                Expanded(
                  child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Row(
                            children: [
                              SizedBox(width: 130,),
                              Text("Not a member yet ?",textAlign: TextAlign.center,),
                              SizedBox(width: 2,),
